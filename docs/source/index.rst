...
- `ex09_advanced_types <https://github.com/gergelyk/python-kickoff/blob/master/examples/ex09_advanced_types/demo.py>`_ Using `IntEnum` and integers in hexadecimal notation.
